# おみくじアプリ - React 3Dインタラクティブ体験

六角形の筒を使った伝統的なおみくじ体験をモダンなWebテクノロジーで再現したReactアプリケーションです。

## プロジェクト概要

- **プロジェクト種別**: インタラクティブおみくじアプリケーション
...
### 🎯 コア機能
- **六角形の筒**: CSS 3Dトランスフォームで実装された美しい六角形おみくじ筒
- **回転アニメーション**: GSAPによる滑らかな回転・反転効果
- **4つの運勢**: 大吉・中吉・小吉・凶のランダム抽選システム
- **棒状の神**: 紙が開く前に現れる演出効果
- **動的結果表示**: 運勢に応じた色分け、メッセージ、イラスト表示

### 🎨 視覚効果
- **パーティクルエフェクト**: 回転中の光の粒子演出
- **段階的アニメーション**: 紙が開く際の複数段階アニメーション
- **キラキラエフェクト**: 結果表示時の装飾エフェクト
- **レスポンシブデザイン**: モバイル・デスクトップ対応

### 📱 インタラクション
- **SNS共有機能**: 結果をSNSでシェア（Web Share API対応）
- **再抽選機能**: 何度でもおみくじを引き直し可能
- **タッチデバイス対応**: スマートフォン・タブレットでの操作
